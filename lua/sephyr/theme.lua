...
theme.set_highlights = function(opts)
    ...
    hl(0, "Keyword", { fg = c.blue_1, bg = c.background })
    ...
    hl(0, "Function", { fg = c.orange_1, bg = "NONE" })
    ...
    hl(0, "@lsp.type.class", { fg = c.foreground, bg = "NONE" })
    hl(0, "@lsp.type.interface", { fg = c.foreground, bg = "NONE" })
    hl(0, "@lsp.type.decorator", { fg = c.foreground, bg = "NONE" })
